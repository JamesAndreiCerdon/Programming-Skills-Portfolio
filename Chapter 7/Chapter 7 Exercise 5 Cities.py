...
#function called "describe_city". It has two required parameters, "city" and "country". 
#In this case, "Country" is being set to Chile by default. Once this is done, it takes the "city" parameter, and concats it with "is in " and then the "country" parameter, and concats it with ". ". 
#It then prints this message onto the console.
