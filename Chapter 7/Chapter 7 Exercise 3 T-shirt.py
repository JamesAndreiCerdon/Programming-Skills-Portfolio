...
#In these two examples, they say "I love Python", and "Readability counts." in the respective sizes. 
#These values are then converted into string values, and outputted on the console.
