...
#"favorite_fruits" is a list containing "cherrys, mango, and oranges.

#The code checks whether a specific fruit is in the list, and then if it is, 
#it prints a message to the console. 
#It does this for five different fruits: watermelon, oranges, cherries, grapes, and mango. 
#If your favorite fruit is one of the ones within the list, you'll get a message that says "You really like..." that particular fruit. 
